{{/* Images assembled by werf, with fallbacks for ordinary Helm deployments. */}}
{{- define "tataredu.backendImage" -}}
{{- $werfImage := dig "werf" "images" "backend" "ref_tag" "" .Values.global -}}
{{- default (printf "%s:%s" .Values.image.backend.repository .Values.image.backend.tag) $werfImage -}}
{{- end }}

{{- define "tataredu.frontendImage" -}}
{{- $werfImage := dig "werf" "images" "frontend" "ref_tag" "" .Values.global -}}
{{- default (printf "%s:%s" .Values.image.frontend.repository .Values.image.frontend.tag) $werfImage -}}
{{- end }}
